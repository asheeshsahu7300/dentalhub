...
const ClinicalFacts = () => {
  return (
    <>
      ...
      >
        <div className="opacity-50 absolute bg-black  w-full h-80"></div>
        <div className="container relative py-8 text-center text-white">
          ...
          <div className="flex justify-between items-center py-16">
            <div className="">
              <h1 className="text-4xl font-Poppins font-extrabold"></h1>
              <p className="text-white italic text-2xl font-Roboto font-semibold">

      ...
      <div className="container lg:flex lg:text-center lg:justify-between">
        <div className="lg:w-1/3">
          <div className="flex">
            ...
            <span className="text-2xl font-Poppins text-secondary">
        ...
        <div className="w-1/3 lg:py-0 py-8">
          <h1 className="text-2xl font-Poppins text-secondary">Quick Links</h1>
          <ul className="py-4">
        ...
        <div className="w-auto">
          <h1 className="text-2xl font-Poppins text-secondary">Subscribe</h1>

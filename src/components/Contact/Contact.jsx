          ...
          <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-6 gap-2 justify-between">
            <div className="">
              <div className="">
                <fieldset>
                  ...
                  />
                  <br />
                  <button type="submit" className="bg-white mt-4 border border-primary text-black py-3 px-6 rounded-md hover:bg-transparent hover:bg-primary hover:text-white transition" disabled={isSubmitting}>
            ...
            <div className="inset-0 lg:px-16 px-8">
              ...
              <div className="flex py-4">
                ...
                <div className="px-8">
                  <p><a href="https://www.instagram.com/dentalhubkalyan/?igsh=MTc0NmF0d2l4bDBuaw%3D%3D&utm_source=qr">Dr-Archanas-Dental-Hub</a></p>
                </div>
              </div>
            </div>
          </div>

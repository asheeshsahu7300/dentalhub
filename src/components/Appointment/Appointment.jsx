    ...
    <>
      ...
      <div className="container py-16">
        ...
        <p className="text-4xl text-center  font-Roboto" style={{fontSize:"22px"}} >
          ...
          If getting  an error message, please book appointment by  calling us at   <i className="fas fa-phone-square-alt text-3xl text-secondary" style={{color:"rgba(103, 108, 184, var(--tw-text-opacity))"}}></i> +91 9833505077
        </p>
      </div>
    </>
  );

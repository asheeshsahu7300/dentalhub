      ...
      <div className="container py-16 flex justify-center">
        <div className="flex flex-col w-full max-w-4xl items-center shadow-2xl mb-8 border-l-2 border-opacity-100 rounded-lg border-primary px-4 sm:px-8 py-8 bg-white transform transition duration-200 hover:scale-105">
          ...
          <fieldset className="w-full max-w-lg">
            <label
              htmlFor="name"
              className="block mb-2 font-bold text-lg font-Poppins py-2 hover:text-primary"
            >
              Name:
            </label>
            <input
          ...
          <p className="text-center font-Roboto mt-8 text-sm sm:text-base">
            If getting an error message, please book an appointment by calling
            us at
            <i
              className="fas fa-phone-square-alt text-2xl text-secondary mx-2"
              style={{ color: "rgba(103, 108, 184, var(--tw-text-opacity))" }}
            ></i>
            +91 9833505077
          </p>
        </div>
